...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, Key_3_Pin|Key_4_Pin|Key_5_Pin|Key_6_Pin
                          |Key_7_Pin|LED_4_Pin|LED_3_Pin|Key_POUND_Pin
                          |Key_AR_Pin|Key_BA_Pin|Key_CF_Pin|Key_DS_Pin
                          |Key_1_Pin|Key_2_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, Key_MT_Pin|Key_8_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : Key_3_Pin Key_4_Pin Key_5_Pin Key_6_Pin
                           Key_7_Pin Key_POUND_Pin Key_AR_Pin Key_BA_Pin
                           Key_CF_Pin Key_DS_Pin Key_1_Pin Key_2_Pin */
  ...
  /*Configure GPIO pins : Key_MT_Pin Key_8_Pin */
  GPIO_InitStruct.Pin = Key_MT_Pin|Key_8_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  ...
  /*Configure GPIO pins : OUT_3_Pin OUT_2_Pin */
  GPIO_InitStruct.Pin = OUT_3_Pin|OUT_2_Pin;
  ...
  /*Configure GPIO pins : LED_MT_Pin OUT_4_Pin OUT_1_Pin */
  GPIO_InitStruct.Pin = LED_MT_Pin|OUT_4_Pin|OUT_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
